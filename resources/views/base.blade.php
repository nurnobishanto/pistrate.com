...
<html lang="en" class="no-js">
  <head>
    <meta charset="utf-8"/>
    <title>Pistrate - Web Design &amp; Digital Marketing Agency</title>
    ...
    <!--website-favicon-->
    <link href="{{asset('frontsite')}}/images/favicon.png" rel="icon">
    <!--plugin-css-->
    ...
    <header class="nav-bg-w main-header navfix fixed-top menu-white">
      <div class="container m-pad">
        ...
        <nav id="main-nav">
          ...
          <ul class="bottom-nav">
            <li class="prb">
              <a href="{{asset('frontsite')}}/tel:+11111111111">
            ...
            <li class="prb">
              <a href="{{asset('frontsite')}}/mailto:somewebmedia@gmail.com">
            ...
            <li class="prb">
              <a href="{{asset('frontsite')}}/skype:niwax.company?call">
          ...
          <div class="col-lg-4 col-sm-12 pt40">
            <div class="footerdez-a">
              ...
              <div class="contactinfo mt30">
                <a href="{{asset('frontsite')}}/mailto:contact@domainame.com">contact@domainame.com <span>→</span></a>
                <a href="{{asset('frontsite')}}/tel:+91123456790">(91) 123 4567 7890 <span>→</span></a>                     
              </div>
            </div>
          </div>
